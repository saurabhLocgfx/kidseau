...
class _TAttendanceScreenState extends State<TAttendanceScreen> {
  ...
  _getData() {
    _isLoading2 = true;
    final resp = TeacherAllAttendanceApi().get(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                                                              ...
                                                              Column(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      Text(
                                                                        model.groupAllkid![index].gender!.toLowerCase() ==
                                                                                'm'
                                                                            ? 'S/O '
                                                                    ...
                                                                    children: [
                                                                      Text(
                                                                        model.groupAllkid!.where((e) => e.name!.toLowerCase().contains(_controller.text.toLowerCase())).toList()[index].gender!.toLowerCase() ==
                                                                                'm'
                                                                            ? 'S/O '
                                                                            : model.groupAllkid!.where((e) => e.name!.toLowerCase().contains(_controller.text.toLowerCase())).toList()[index].gender!.toLowerCase() == 'f'
                                                                                ? 'D/O '
                                                                                : 'C/O ',
                                                                        style: FontConstant
                                                                            .k14w4008471Text,
      ...
      bottomNavigationBar: DateFormat("yyyy-MM-dd").format(_selectedDay) !=
