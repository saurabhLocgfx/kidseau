                     ...
                     /* InkWell(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            color: Color(0xffFFFFFF),
                            borderRadius: BorderRadius.all(Radius.circular(30))),
                        child: _isLoading? SizedBox.shrink() :DropdownButton<String>(
                          alignment: Alignment.centerLeft,
                          borderRadius: BorderRadius.circular(30),
                          dropdownColor: Color(0xffffffff),
                          isExpanded: true,
                          ...
                          onChanged: (String? val) {
                            ...
                            setState(() {
                              _selectedGroup = val!;
                              for (int i = 0; i <= _groupMap.length - 1; i++) {
                          ...
                          if (s == '@') {
                            ...
                            resp.then((value) {
                              log(value.toString());
                                ...
                                log("suggested data"+suggestedData.toString());
                                /*setState(() {
                                  suggestedData
                                      .toSet()
                                      .toList();
                      ...
                      Container(height: 50,
                        ...
                        shrinkWrap: true,
                          ...
                          return Container(
                            ...
                            child: Center(child: Text(_taggedStudents[index], style: FontConstant.k16w400whiteText,)),
                          );
                          }, separatorBuilder: (ctx, ind)=> SizedBox(width: 5,), itemCount: _taggedStudents.length)),
                      /*TextFormField(
                        validator: (val){
          ...
          child: materialButton(
            context, () {
              ...
              if(!_isLoading){
                ...
                final resp = TeacherPostAPI().get(idList: taggedStudentsId, caption: _captionController.text, secId: selectedSection['id'], grpId: selectedGroup['id'], imgList: widget.pickedImages);
                resp.then((value){
