        ...
        body: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                SizedBox(height:40),
                Center(child: Image.asset("assets/images/logo without text.png",height: 53,width: 63,)),
                SizedBox(height:40),
                Text("Add Kid",style: FontConstant.k16w500brownText.copyWith(fontSize: 24),),
                SizedBox(height:24),
                Text("Voucher's code",style: FontConstant.k16w500brownText.copyWith(fontSize: 16),),
                SizedBox(height:08),
                textfield(context, "Enter your Voucher’s code"),
                Padding(
                  padding: const EdgeInsets.only(left: 16.0),
                  child: Text("Vouchers are given by kid’s school",style: FontConstant.k14w400lightpurpleText,),
                ),
                SizedBox(height:40),
                Stack(
                  children: [
                    Container(
                      ...
                      width: 382,
                      decoration: BoxDecoration(
                          image: DecorationImage(image: AssetImage("assets/images/Rectangle 2713 card add kid.png"))
                      ),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(top: 80.0),
                      child: Center(child: Image.asset("assets/images/playicon.png",height: 56,width: 56,)),
                    ),
                  ] 
                ),
                SizedBox(height:108),
