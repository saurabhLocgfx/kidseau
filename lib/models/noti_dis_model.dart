// class NotificationDisModel {
//   String? postId;
//   String? captions;
//   String? postTime;
//   List<String>? images;
//
//   NotificationDisModel({
//     this.postId,
//     this.captions,
//     this.postTime,
//     this.images,
//   });
//
//   NotificationDisModel.fromJson(Map<String, dynamic> json) {
//     postId = json['post_id'];
...
//   List<String>? images;
//
//   Dis({this.postId, this.captions, this.postTime, this.images});
//
...
class AllNotificationModel {
  ...
  AllNotificationModel.fromJson(Map<String, dynamic> json) {
    ...
    dis = json['dis'] != null ? new Dis.fromJson(json['dis']) : null;
  }
